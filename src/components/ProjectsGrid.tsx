...
export function ProjectsGrid({ projects }: ProjectsGridProps) {
  ...
  return (
    <section className="section pg-section" id="projects" data-reveal-section>
      <div className="pg-header" data-reveal-item>
        <span className="pg-eyebrow">Selected Work</span>
        <h2 className="pg-title">Projects I've built</h2>
      </div>

      <div className="pg-grid">
        {visible.map((p, i) => (
          <article key={p.title} className="pg-card" data-reveal-item>
