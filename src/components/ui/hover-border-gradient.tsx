...
export function HoverBorderGradient({
  ...
  // Accent color (#D8D8F0) used for secondary border
  const ACCENT = '#D8D8F0'
  ...
  const secondaryHover = `radial-gradient(75% 181% at 50% 50%, ${ACCENT} 0%, rgba(216,216,240,0) 100%)`
  ...
  return (
    <Tag
      ...
      style={{
        ...
        overflow: 'visible',
        cursor: 'pointer',
        border: variant === 'secondary' ? '1px solid rgba(216,216,240,0.3)' : '1px solid rgba(255,255,255,0.12)',
